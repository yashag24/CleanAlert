...
const UploadArea = () => {
  ...
  return (
    <div className="relative group">
      <div className={`relative border-2 rounded-lg transition-all duration-300 ease-in-out overflow-hidden h-96 ${
        ...
        {!preview ? (
          <div className="h-full flex flex-col items-center justify-center p-4">
            ...
            <p className="text-base font-medium text-green-900 text-center">
              Drag & drop an image
            </p>
          ...
          <div className="h-full p-4">
            <div className="relative w-full h-full rounded-lg overflow-hidden shadow-md flex items-center justify-center bg-green-50">
              <img
                src={preview}
                alt="Preview"
